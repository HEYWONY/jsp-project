...
<form method="post" action="join_result.do" >
    ...
    <ul>
        ...
        <li>
            <label>주소</label><br>
            <input type="text" name="" id="sample6_postcode" placeholder="우편번호">
            <input type="button"  onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
            <input type="text" name="" id="sample6_address" placeholder="주소"><br>
            <input type="text" name="" id="sample6_detailAddress" placeholder="상세주소">
            <input type="text" name="" id="sample6_extraAddress" placeholder="참고항목">
